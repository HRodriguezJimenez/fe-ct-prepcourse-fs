...
function tieneEmail(objetoUsuario) {
   ...
   //El Método .hasOwnProperty() devuelve un valor BOOLEANO true ó false si existe y ademas cumple las otras condiciones que le pasamos la respuesta va a ser true de lo contrario si alguna condición no se cumple retornara false
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
   ...
   //Con la secuencia de dot-notation estamos accediendo a la propiedad "amigos" y el ser un array nos deja agragarle o eliminarle elementos de manera sencilla.
