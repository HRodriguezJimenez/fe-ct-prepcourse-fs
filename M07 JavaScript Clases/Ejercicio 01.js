...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function(){
    ...
    for(let i = 0; i < this.length; i++){//this se refiere al string que desee aplicar este método.
        array.push(this[i]);//Pusheara todas letras que contenga el string que lo invoque.
    }
    let numeroInvertido = array.reverse().join('');//invertimos el orden de todo el array y lo convertimos
    return numeroInvertido;//en un string para retornarlo.
   }
}
